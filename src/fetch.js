...
async function fetchFeeds(
  ...
  const response = await fetch(
    "https://nextdoor.co.uk/api/gql/ContentFromHoodFeed",
    {
      headers: {
        accept: "*/*",
      ...
      body: JSON.stringify({
        ...
        variables: {
          ...
          input: {
            ...
            supportedFeatures: {
              ...
              rollupItemTypes: ["LIST_CARD", "IMAGE_CARD"],
              rollupTypes: ["CAROUSEL", "LIST"],
            },
        ...
        extensions: {
          persistedQuery: {
            version: 1,
            sha256Hash:
              "5c0c6348401fe85bf454e93b32422d0137721139beb56833ab2db1dcf8e62014",
          },
        },
      }),
      method: "POST",
